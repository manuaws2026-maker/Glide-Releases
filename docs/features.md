...
- **Inset border** — a subtle inner frame in any color/opacity.
...
- **Zoom speed** — spring stiffness / smoothness / momentum presets for the in/out motion.
...
## Voiceover (AI)
- **Describe your product** in a sentence; Glide writes a natural, audience‑aware script by watching the video.
...
## Timeline
- Trim and cut clips, change playback speed.
