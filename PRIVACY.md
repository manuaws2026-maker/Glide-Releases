...
> - **Usage analytics are pseudonymous and easy to turn off.** They cover no name, no recordings, no scripts, and no keys: just feature-usage and error signals tied to a random local ID, which you can turn off anytime in **Help → Privacy & analytics**.
...
**How your data flows.** When you use an AI feature, the relevant data is sent **from your Mac directly to the provider you configured, and it does not pass through us:**
